...
export default function DownloadGuide() {
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-5 rounded-lg border border-slate-200 bg-blue-50 p-5 text-sm text-slate-600">
        <p className="font-semibold text-slate-950">개인정보와 분석 기준</p>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>파일 내용, 사용자명, 결과 목록, 파일명은 이 앱 서버로 전송하지 않습니다.</li>
          <li>분석 결과는 Instagram 내보내기 파일이 생성된 시점을 기준으로 합니다.</li>
          <li>ISeeSocial은 Instagram 또는 Meta의 공식 서비스가 아닙니다.</li>
          <li>광고를 도입하더라도 분석 데이터와 광고 스크립트는 분리해야 합니다.</li>
        </ul>
      </div>
